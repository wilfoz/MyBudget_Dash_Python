...
layout = dbc.Col([
    ...
    html.P("By Wilerson", className="text-info"),
    html.Hr(),
...
# Seção NOVO ---------------------------------
    ...
    dbc.Row([
        dbc.Col([
            dbc.Button(color="success", id="open-nova-receita", children=['+ Receita'])
        ], width=6),
        dbc.Col([
            dbc.Button(color="danger", id="open-nova-despesa", children=['- Despesa'])
        ], width=6),
    ]),
...
# Modal Receita ---------------------------------
    dbc.Modal([
        ...
        dbc.ModalBody([
            ...
            dbc.Row([
                ...
                dbc.Col([
                    dbc.Label("Categoria de receita: "),
                    dbc.Select(
                        id="select_receita", 
                        ...
                        dbc.Row([
                            ...
                            dbc.Col([
                                ...
                                dbc.Checklist(
                                    ...
                                    input_checked_style={"background-color": "blue", "border-color": "orange"}
                                ),
    ...
    ], id="modal-nova-receita", size="lg", is_open=False, centered=True, backdrop=True),
...
# Modal Despesa ---------------------------------
    dbc.Modal([
        ...
        dbc.ModalBody([
            dbc.Row([
                dbc.Col([
                    dbc.Label("Descrição: "),
                    dbc.Input(placeholder="Ex. contas, compras...", id="txt-despesa"),
                ], width=6),
                dbc.Col([
                    dbc.Label("Valor: "),
    ...
    ], id="modal-nova-despesa", size="lg", is_open=False, centered=True, backdrop=True),
...
def salve_form_receita(n1, descricao, valor, date, switches, categoria, dict_receitas):
    # import pdb
    # pdb.set_trace()
    df_receitas = pd.DataFrame(dict_receitas)

    if n1 and not(valor == "" or valor == None):
...
def salve_form_despesa(n1, descricao, valor, date, switches, categoria, dict_despesas):
    # import pdb
    # pdb.set_trace()
