    ...
    dbc.Row([
        ...
        dbc.Col([
            dbc.CardGroup([
                dbc.Card([
                    html.Legend("Saldo"),
                    html.H5("R$ 10000", id="p-saldo-dashboards", style={})
                ], style={"padding-left": "20px", "padding-top": "10px"}),
                dbc.Card([
                    html.Div(className="fa fa-university", style=card_icon),
                ], color="warning", style={"maxWidth": "75px", "height": "100px", "margin-left": "-10px"})
            ])
        ], width=4),
        ...
        dbc.Col([
            dbc.CardGroup([
                ...
                ], color="danger", style={"maxWidth": "75px", "height": "100px", "margin-left": "-10px"})
            ])
        ], width=4)
    ], style={"margin": "10px"}),
    dbc.Row([
        ...
        dbc.Col([
            dbc.Card([
                dcc.Graph(id="graph1", style={"height": "100%", "padding": "10px"})
            ])
        ], width=8),
    ], style={"margin": "10px"}),
...
def graph1_show(data_despesa, data_receita):
